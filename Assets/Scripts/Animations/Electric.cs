...
public class Electric : MonoBehaviour
{
    ...
    public void CalculatePoints(Vector3 _start, Vector3 _end,LineRenderer lRend)
    {
        ...
        if (timer > timerTimeOut)
        {
            ...
            points[pointIndexA] = _start;
            points[pointIndexE] = _end;
            ...
            float distance = Vector3.Distance(_start, _end) / points.Length;
